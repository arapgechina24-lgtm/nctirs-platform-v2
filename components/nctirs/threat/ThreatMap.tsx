...
export function ThreatMap({ incidents, predictions, surveillance }: ThreatMapProps) {
  ...
  useEffect(() => {
    ...
    const initMap = async () => {
      ...
      // Initialize map centered on Kenya using a premium Dark Mode tile layer
  ...
  return (
    <Card className="glass-panel border-green-900/40 bg-transparent flex flex-col h-full">
      <CardHeader>
