    ...
    <>
      ...
      <header className="border-b border-green-900/40 bg-black/95 backdrop-blur-md relative z-10">
        ...
        <div className="bg-green-950 border-b border-green-800">
          <div className="flex items-center justify-center sm:justify-between px-2 sm:px-6 py-1">
            ...
            <div className="hidden sm:flex items-center gap-3 text-[10px] text-green-500">
        ...
        <div className="flex h-20 items-center px-4 sm:px-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="hidden sm:block text-[10px] text-green-800 tracking-[0.2em] mt-1 font-bold uppercase">
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-6">
            ...
            {/* Date/Time */}
            <div className="hidden md:flex flex-col items-end gap-1 px-4 py-2 bg-black border border-green-900/50 rounded-none">
        ...
        {/* Navigation */}
        <div className="border-t border-green-900/40 bg-gradient-to-b from-black/80 to-black/95 overflow-x-auto" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          <nav className="flex sm:grid sm:grid-cols-5 w-full min-w-max sm:min-w-full">
            {[
              ...
              <button
                ...
                className={`flex-1 min-w-[120px] sm:min-w-0 group relative flex flex-col items-center justify-center gap-1 py-3 px-2 text-center transition-all duration-200 border-r border-green-900/30 last:border-r-0
